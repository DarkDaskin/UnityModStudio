...
[TestClass]
public class BepInEx6UnityMonoBuildTests : BuildTestsBase
{
    [TestMethod]
    public void WhenProjectHasNoVersion_BuildAndDeploy()
    {
        ...
        var (project, logger) = GetProjectWithRestore(@"Projects\BepInEx6UnityMono\NonVersioned\Mod.csproj");
        ...
        Assert.IsTrue(File.ReadAllLines(doorstopConfigPath).Contains(@"target_assembly=BepInEx\core\BepInEx.Unity.Mono.Preloader.dll"));
    }
    ...
    public void WhenProjectHasSingleVersion_BuildAndDeploy()
    {
        ...
        ResolveGameProperties(game);
        SetupGameRegistry(game);
        var (project, logger) = GetProjectWithRestore(@"Projects\BepInEx6UnityMono\SingleVersion\Mod.csproj");
    ...
    public void WhenProjectHasMultipleVersions_BuildAndDeploy()
    {
        ...
        var (project, logger) = GetProjectWithRestore(@"Projects\BepInEx6UnityMono\MultiVersion\Mod.csproj");
    ...
    public void WhenProjectHasMultipleVersionsAndMultipleFrameworks_BuildAndDeploy()
    {
        ...
        var (project, logger) = GetProjectWithRestore(@"Projects\BepInEx6UnityMono\MultiVersionMultiTarget\Mod.csproj");
    ...
    public void WhenProjectHasModSourcePath_BuildAndDeploy()
    {
        ...
        ResolveGameProperties(game);
        SetupGameRegistry(game);
        var (project, logger) = GetProjectWithRestore(@"Projects\BepInEx6UnityMono\WithModSourcePath\Sources\Mod.csproj");
